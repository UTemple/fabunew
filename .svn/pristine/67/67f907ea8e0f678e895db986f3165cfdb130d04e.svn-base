            ...
            if (currData.length != 0) {
                for (var i = 0; i < currData.length; i++) {
                    dataHtml += '<tr>'
                        ...
                        + '<td>' + currData[i].SEWAGEFARM + '</td>'
                        + '<td>' + currData[i].DRAINPUMP + '</td>'
                        + '<td>' + currData[i].DRAINGATE + '</td>'
                        + '<td>' + currData[i].DRAINPIPE + '</td>'
                        + '<td>' + currData[i].DRAINCANAL + '</td>'
                        + '<td>' + currData[i].DRAINCOMB + '</td>'
                        + '<td>' + currData[i].DRAINWELL + '</td>'
