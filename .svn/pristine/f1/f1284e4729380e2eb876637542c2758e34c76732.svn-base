...
<body class="childrenBody">
    <form id="form1" class="layui-form" style="width:48%;float:left">
        ...
        <div class="layui-form-item">
            ...
            <div class="layui-inline">
                <label class="layui-form-label">行政区</label>
                <div class="layui-input-block">
                    <select name="projectDistrict" class="projectDistrict">
                        <option>白云区</option>
                        <option>从化区</option>
                        <option>番禺区</option>
                        <option>海珠区</option>
        ...
        <div class="layui-form-item">
            <%--<div class="layui-inline">--%>
                ...
                <div class="layui-input-block" id="employerDiv">
                    <select id="employerSel" name="projectEmployer" class="projectEmployer" lay-filter="InputEmployer" lay-search runat="server">
                        <%--<option value="">请选择业主单位</option>
                        <option value="in">未找到，手动输入...</option>
    ...
    <script>
        ...
        layui.config({
            ...
            form.on('select(InputEmployer)', function (data) {
                if (data.value == "in")
                {
                    //var employerdiv = window.getElementById("employerDiv");
                    var employerdiv = $("#employerDiv");
                    employerdiv.html('<input type="text" name="projectEmployer" class="layui-input" lay-verify="required" placeholder="请输入业主单位" />');
                }
            });
        })
